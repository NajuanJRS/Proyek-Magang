                        ...
                        <div class="card shadow-sm rounded-4">
                                ...
                                <form method="POST" action="{{ route('admin.berita.update', $berita->id_berita) }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if ($berita->gambar1)
                                            <div class="mt-2">
                                                <img id="oldPreview1"
                                                    src="{{ asset('storage/berita/' . $berita->gambar1) }}"
                                                    alt="Gambar Berita 1"
                            ...
                            <div id="tombol2"
                                ...
                                <div class="mb-4">
                                    ...
                                    @if ($berita->gambar2)
                                        <div class="mt-2">
                                            <img id="oldPreview2" src="{{ asset('storage/berita/' . $berita->gambar2) }}"
                                                alt="Gambar Berita 2"
                                                style="max-width: 200px; border-radius: 8px; border:1px solid #ddd; padding:4px;">
                                        </div>
                            ...
                            <div id="tombol3"
                                ...
                                <div class="mb-4">
                                    ...
                                    @if ($berita->gambar3)
                                        <div class="mt-2">
                                            <img id="oldPreview3" src="{{ asset('storage/berita/' . $berita->gambar3) }}"
                                                alt="Gambar Berita 3"
                                                style="max-width: 200px; border-radius: 8px; border:1px solid #ddd; padding:4px;">
                                        </div>
                                        <div class="form-check mt-2">
