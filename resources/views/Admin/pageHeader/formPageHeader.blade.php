                    ...
                    <div class="col-md-16 grid-margin stretch-card">
                        <div class="card">
                            ...
                            @endif
                                ...
                                <form class="forms-sample" method="POST" action="{{ route('admin.pageHeader.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="judul" name="judul" placeholder="Masukkan Judul Header">
                                    </div>

                                    <div class="form-group">
                                        <label for="gambar_header">Unggah Gambar</label>
                                        <input type="file" class="form-control" id="gambar_header" name="gambar_header">
                                    </div>

                                    <div class="form-group">
                                        <label for="deskripsi">Deskripsi :</label>
                                        <textarea class="form-control my-editor" id="deskripsi" name="deskripsi" rows="10" placeholder="Masukkan Deskripsi Layanan"></textarea>
                                    </div>
