                    ...
                    <div class="card shadow-sm rounded-4">
                        <div class="card-body px-4 py-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="card-title mb-0">Konten Layanan</h4>
                            </div>
                            ...
                            <div class="d-flex justify-content-end mb-4">
                                <form action="{{ route('admin.layanan.index') }}" method="GET" style="width: 270px;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if (!empty($k->kategoriKonten->icon_konten))
                                                        <img src="{{ asset('media/' . $k->kategoriKonten->icon_konten) }}"
                                                ...
                                                {{-- Tombol Aksi --}}
                                                <td class="text-center">
                                                        <a href="{{ route('admin.layanan.edit', $k->id_konten) }}"
                                                            class="btn btn-info btn-sm btn-circle rounded-circle d-inline-flex me-1">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-danger btn-sm btn-circle rounded-circle d-inline-flex me-1"
                                                            onclick="deleteData('{{ $k->id_konten }}')">
                                                            <i class="bi bi-trash"></i>
                                                        </a>
                                                        <form id="delete-form-{{ $k->id_konten }}"
                                                            action="{{ route('admin.layanan.destroy', $k->id_konten) }}"
                            ...
                            <div class="mt-4 d-flex justify-content-end">
                                    {{ $kontenLayanan->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
