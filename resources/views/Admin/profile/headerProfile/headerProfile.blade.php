                        ...
                        <div class="card shadow-sm rounded-4">
                            <div class="card-body px-4 py-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4 class="card-title mb-0">Header Profile</h4>
                                </div>
                                ...
                                <div class="table-responsive custom-table-container">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            @php $no = 1; @endphp
                                            @forelse($headerProfile as $h)
                                                @if (($h->kategoriHeader->nama_kategori ?? '') === 'Heading Profil')
                                                    <tr>
                                                        ...
                                                        @php
                                                            $fullText = trim(
                                                                preg_replace(
                                                                    '/\s+/',
                                                                    ' ',
                                                                    html_entity_decode(strip_tags($h->keterangan)),
                                                                ),
                                                            );
                                                        @endphp
                                                        ...
                                                        <td class="isi-konten text-center">
                                                            ...
                                                            @if (mb_strlen($fullText) > 160)
                                                                <button type="button" class="btn btn-link p-0 see-more"
                                                                    data-id="{{ $h->id_header }}" data-judul="Keterangan">
                                                                    Lihat selengkapnya
                                                                </button>
                                                            @endif
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('admin.headerProfile.edit', $h->id_header) }}"
