                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST"
                                    action="{{ route('admin.layanan.update', $layananKami->id_layanan) }}"
                                    ...
                                    <div class="form-group">
                                            ...
                                            @if ($layananKami->icon)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/icon/' . $layananKami->icon) }}"
                                                        alt="Gambar Layanan" width="120" style="border-radius: 8px;">
                                                </div>
                                            @endif
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="judul" name="judul"
                                            value="{{ old('judul', $layananKami->judul) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control my-editor" id="isi_layanan1" name="isi_layanan1" rows="10"
                                            placeholder="Masukkan Isi Layanan">{{ old('isi_layanan1', $layananKami->isi_layanan1) }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="gambar1">Unggah Gambar 1</label>
                                        <input type="file" class="form-control" id="gambar1" name="gambar1">
                                        @if ($layananKami->gambar1)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/layanan/' . $layananKami->gambar1) }}"
                                                    alt="Gambar Layanan" width="120" style="border-radius: 8px;">
                                            </div>
                                        @endif
                                    </div>

                                    <!-- Tombol untuk buka layanan 2 -->
                                    <div class="mb-3">
                                    ...
                                    <!-- Layanan 2 -->
                                    <div id="tombol2"
                                        style="display: {{ $layananKami->isi_layanan2 || $layananKami->gambar2 ? 'block' : 'none' }};">
                                        <div class="form-group">
                                            <label for="isi_layanan2">Isi Layanan 2:</label>
                                            <textarea class="form-control my-editor" id="isi_layanan2" name="isi_layanan2" rows="10">{{ old('isi_layanan2', $layananKami->isi_layanan2) }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="gambar2">Unggah Gambar 2</label>
                                            <input type="file" class="form-control" id="gambar2" name="gambar2">
                                            @if ($layananKami->gambar2)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/layanan/' . $layananKami->gambar2) }}"
                                                        alt="Gambar Layanan" width="120" style="border-radius: 8px;">
                                                </div>
                                            @endif
                                        </div>

                                        <!-- Tombol untuk buka layanan 3 -->
                                        <div class="mb-3">
                                            <button type="button" class="btn btn-sm btn-gradient-primary"
                                                id="toggle-tombol3">
                                                + Tambah Layanan 3
                                    ...
                                    <!-- Layanan 3 -->
                                    <div id="tombol3"
                                        style="display: {{ $layananKami->isi_layanan3 || $layananKami->gambar3 ? 'block' : 'none' }};">
                                        <div class="form-group">
                                            <label for="isi_layanan3">Isi Layanan 3:</label>
                                            <textarea class="form-control my-editor" id="isi_layanan3" name="isi_layanan3" rows="10">{{ old('isi_layanan3', $layananKami->isi_layanan3) }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="gambar3">Unggah Gambar 3</label>
                                            <input type="file" class="form-control" id="gambar3" name="gambar3">
                                            @if ($layananKami->gambar3)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/layanan/' . $layananKami->gambar3) }}"
                                                        alt="Gambar Layanan" width="120" style="border-radius: 8px;">
                                                </div>
                                            @endif
                                        </div>
