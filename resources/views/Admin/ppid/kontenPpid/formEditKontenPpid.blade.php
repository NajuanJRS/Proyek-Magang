                ...
                <div class="col-xl-10 col-lg-11">
                    <div class="card shadow-sm rounded-4">
                        <div class="card-body px-5 py-4">
                            ...
                            <h4 class="mb-5">Edit Konten Ppid</h4>
                            ...
                            <form method="POST" action="{{ route('admin.ppid.update', $kontenPpid->id_konten) }}" enctype="multipart/form-data">
                                    ...
                                    @if (!empty($kontenPpid->kategoriKonten->icon_konten))
                                        <div class="mt-2">
                                            <img id="oldPreviewIcon"
                                                 src="{{ asset('storage/' . $kontenPpid->kategoriKonten->icon_konten) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="custom-editor-container">
                                        ...
                                        <div id="editor1" class="custom-editor" contenteditable="true">{!! old('isi_konten1', $kontenPpid->isi_konten1) !!}</div>
                                ...
                                <div class="mb-4">
                                    ...
                                    @if ($kontenPpid->gambar1)
                                        <div class="mt-2">
                                            <img id="oldPreview1"
                                                 src="{{ asset('storage/' . $kontenPpid->gambar1) }}"
                                                 alt="Gambar Lama 1"
                                ...
                                <div id="tombol2"
                                    ...
                                    <div class="custom-editor-container">
                                        ...
                                        <div id="editor2" class="custom-editor" contenteditable="true">{!! old('isi_konten2', $kontenPpid->isi_konten2) !!}</div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if ($kontenPpid->gambar2)
                                            <div class="mt-2">
                                                <img id="oldPreview2"
                                                     src="{{ asset('storage/' . $kontenPpid->gambar2) }}"
                                                     alt="Gambar Lama 2"
                                                     style="max-width:200px; border-radius:8px; border:1px solid #ddd; padding:4px;">
                                            </div>
                                ...
                                <div id="tombol3"
                                    ...
                                    <div class="custom-editor-container">
                                        ...
                                        <div id="editor3" class="custom-editor" contenteditable="true">{!! old('isi_konten3', $kontenPpid->isi_konten3) !!}</div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if ($kontenPpid->gambar3)
                                            <div class="mt-2">
                                                <img id="oldPreview3"
                                                     src="{{ asset('storage/' . $kontenPpid->gambar3) }}"
                                                     alt="Gambar Lama 3"
                                                     style="max-width:200px; border-radius:8px; border:1px solid #ddd; padding:4px;">
                                            </div>
                                            <div class="form-check mt-2">
