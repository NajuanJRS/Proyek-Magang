                    ...
                    <div class="card shadow-sm rounded-4">
                        <div class="card-body px-4 py-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="card-title mb-0">Konten PPID</h4>
                            </div>
                            ...
                            <div class="d-flex justify-content-end mb-4">
                                <form action="{{ route('admin.ppid.index') }}" method="GET" style="width: 270px;">
                                    ...
                                    <tbody>
                                        @foreach($kontenPpid as $k)
                                            <tr>
                                                ...
                                                {{-- Tombol Aksi --}}
                                                <td class="text-center">
                                                        <a href="{{ route('admin.ppid.edit', $k->id_konten) }}"
                                                        ...
                                                        <form id="delete-form-{{ $k->id_konten }}"
                                                            action="{{ route('admin.ppid.destroy', $k->id_konten) }}"
                            ...
                            <div class="mt-4 d-flex justify-content-end">
                                    {{ $kontenPpid->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
