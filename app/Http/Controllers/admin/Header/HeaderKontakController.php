...
class HeaderKontakController extends Controller
{
     ...
     */
    public function edit(Header $headerKontak): View
    {
     ...
     */
    public function update(Request $request, Header $headerKontak): RedirectResponse
    {
        if ($headerKontak->id_kategori_header != 7) {
        ...
        if ($request->hasFile('gambar')) {
            $this->hapusGambarLama($headerKontak->gambar);
