...
class HeaderPpidController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        // Filter hanya untuk id_kategori_header = 6 (Heading PPID)
     ...
     */
    public function edit(Header $headerPpid): View // Tambahkan View return type
    {
        // FindOrFail tidak perlu jika menggunakan Route Model Binding
        // Pastikan hanya bisa edit header ppid (id_kategori_header = 6)
     ...
     */
    public function update(Request $request, Header $headerPpid): RedirectResponse // Tambahkan RedirectResponse
    {
        // Pastikan hanya bisa update header ppid (id_kategori_header = 6)
        if ($headerPpid->id_kategori_header != 6) {
        ...
        if ($request->hasFile('gambar')) {
            $this->hapusGambarLama($headerPpid->gambar); // Hapus gambar lama
