...
class HeaderDownloadController extends Controller
{
     ...
     */
    public function edit(Header $headerDownload): View
    {
     ...
     */
    public function update(Request $request, Header $headerDownload): RedirectResponse
    {
        if ($headerDownload->id_kategori_header != 5) {
        ...
        if ($request->hasFile('gambar')) {
            $this->hapusGambarLama($headerDownload->gambar);
